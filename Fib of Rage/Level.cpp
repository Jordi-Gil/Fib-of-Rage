...
void Level::setAnimations()
{
	...
	characters[0]->setPosition(glm::vec2(INIT_PLAYER_X_TILES + 500, INIT_PLAYER_Y_TILES + 20));
	...
	characters[1]->setPosition(glm::vec2(INIT_PLAYER_X_TILES + 600, INIT_PLAYER_Y_TILES + 30));
	...
	characters[2]->setPosition(glm::vec2(INIT_PLAYER_X_TILES + 700, INIT_PLAYER_Y_TILES + 80));
